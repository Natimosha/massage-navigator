...
function finalPage(data, pageNum, totalPages) {
    const content = `
        ...
        <p class="lead" style="text-align: center; max-width: 500px; margin: 0 auto 40px;">
            Вы получили план — это 20% успеха. Остальные 80% — в реализации. 
            Не откладывайте первый шаг.
        </p>
        
        <div class="cta-card">
            <div class="cta-title">Курс «7 дней — 7 шагов к доходу на массаже»</div>
            <p class="cta-desc">
                Полная система привлечения и удержания клиентов. 7 модулей, 20+ шаблонов, 
                работает в любом городе России.
            </p>
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="cta-price">от 6 500 р.</span>
                <span class="cta-link">lp.massagestart.ru</span>
            </div>
        </div>
        ...
        <div class="cta-card" style="border-color: #7ec8a3;">
            ...
            <p class="cta-desc">
                Индивидуальная работа один на один. Разберём вашу ситуацию детально 
                и составим план с поддержкой на каждом этапе.
            </p>
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <span class="cta-price">39 900 р.</span>
                <span class="cta-link" style="color: #7ec8a3;">Заявка на сайте</span>
            </div>
        </div>
        
        <div class="divider"></div>
        
        <div style="text-align: center; padding: 24px; background: #12121c; border-radius: 12px;">
            <p style="color: #888; margin-bottom: 8px;">Вопросы по плану:</p>
            <p style="color: #d4a574; font-size: 18px; font-weight: 600;">7days@massagestart.ru</p>
        </div>
    `;
